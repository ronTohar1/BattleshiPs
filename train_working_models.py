...
def main():
    ...
    sucssesful_run =[]
    sucssesful_run.append([3_000_000, 0.00001, 0.99, 'dqn', '[]', 'relu', 'CnnPolicy', 256, 'cnn'])
    sucssesful_run.append([3_000_000, 0.00001, 0.99, 'dqn', '[]', 'relu', 'CnnPolicy', 512, 'cnn'])
    sucssesful_run.append([3_000_000, 0.00001, 0.99, 'dqn', '[256]', 'relu', 'CnnPolicy', 256, 'cnn'])
    sucssesful_run.append([3_000_000, 0.00001, 0.99, 'dqn', '[]', 'relu', 'CnnPolicy', 350, 'cnn'])
    sucssesful_run.append([3_000_000, 0.000005, 0.99, 'dqn', '[]', 'relu', 'CnnPolicy', 512, 'cnn'])
